...
function StringEncoder.process(code)
    ...
    -- BUG FIX: the original emitted isValidChar twice (once before and once after
    -- the decrypt function), causing a duplicate-local error at runtime.
    -- Only emit it once, before the decrypt function that references it.
